# Generated by Powerlevel10k configuration wizard on 2020-05-27 at 19:53 IST.
...
# dotted, no frame, darkest-ornaments, sparse, many icons, concise,
...
() {
  ...
  # POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR=' ' bel2200.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='ﬦ' #'❯' ﬦ  ﲸ
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=178
